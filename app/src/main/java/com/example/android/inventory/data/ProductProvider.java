...
public class ProductProvider extends ContentProvider {
    ...
    /**
        ...
        private Uri insertProduct(Uri uri, ContentValues values) {
            ...
            // If the price is provided, check it's greater than or equal to 0 rupees
            ...
            // If the quantity is provided, check that it's greater than or equal to 0 rupees
        ...
        private int updateProduct(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
            ...
            // Update the selected products in the inventory database table with the given ContentValues
